...
urlpatterns = [
    ...
    path('employee/<int:employees_pk>/edit_assignments', views.editAssignments, name = 'editAssignments'),
    path('employee/<int:employees_pk>/edit_skills', views.editSkills, name = 'editSkills'),
]
